...
from src.lstrudel import LStrudel
...
class CrossValidation:
    ...
    def cross_validate(self, dataset: pandas.DataFrame):
        profile_columns = ['file_name', 'sheet_name']

        clean_dataset = dataset[dataset['line_label'] != 'empty'].reset_index()
